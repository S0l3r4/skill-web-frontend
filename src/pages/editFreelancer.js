...
export default function EditFreelancer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // CORREÇÃO: Garantir que cpf_freelancer seja string antes de usar replace
      const cpfValue = formData.cpf_freelancer ? String(formData.cpf_freelancer).replace(/\D/g, '') : '';
      ...
      const updateData = {
        ...
        cpf: cpfValue, // USANDO A VARIÁVEL CORRIGIDA
