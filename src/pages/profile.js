...
export default function Profile() {
  ...
  // ✅ BUSCAR PERFIL DIRETO DO SUPABASE
  const fetchUserProfile = async () => {
    try {
      setLoading(true);
      setError('');
      console.log("🔄 Buscando perfil do Supabase...");
      ...
      // Combinar dados do Auth com dados da tabela USER
      setUser({
        ...session.user,
        ...userData,
        email: session.user.email // Garantir que o email vem do Auth
      });
  ...
  // Estados de loading (mantido igual)
  if (loading) {
    return (
      <div className="profile">
        ...
        <div className="loading-container">
          ...
          <small>Buscando dados do Supabase</small>
        </div>
      </div>
    );
  }

  // Estados de erro (mantido igual)
  if (error && !user) {
    return (
      <div className="profile">
        <header>
  ...
  // ✅ RESTANTE DO JSX (MANTIDO IGUAL) - só mudei a lógica de dados
  return (
    <div className="profile">
      <header>
            ...
            <div className="details-grid">
              <div className="detail-card">
                ...
                <div className="detail-content">
                  ...
                  <span>{user?.ocuppation_freelancer || 'Não informada'}</span>
                </div>
              </div>
